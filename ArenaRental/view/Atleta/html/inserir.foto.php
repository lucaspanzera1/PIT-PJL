...
<head>
    ...
    <link rel="stylesheet" href="../../User/css/inserir.foto.css?v=<?= time() ?>">
</head>
<body>
...
?>
    ...
    <form method="POST" action="../../../model/User/proc_upload.php" enctype="multipart/form-data">
    ...
    <label class="picture" for="picture__input" tabIndex="0">
      ...
      <input type="submit" id="Continuar" value="Enviar">
        ...
        <script src="../../User/java/foto.pfp.js"></script>
       </form>
