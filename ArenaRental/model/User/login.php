...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    require('../../controller/conexao.php'); // Incluindo o arquivo de conexão
    ...
    if ($user) {
        ...
        } elseif ($user['tipo'] == 'Dono') {
            header("refresh: 1; url=http://localhost/ArenaRental/view/html/quadra.php");
        }
        exit();
    } else {
        echo "<META HTTP-EQUIV=REFRESH CONTENT='0;URL=http://localhost/ArenaRental/view/User/html/login.php'>
