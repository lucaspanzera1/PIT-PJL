...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (validaCPF($cpfInput)) {
            ...
            <script type=\"text/javascript\">
                alert(\"CPF inválido.\");
                window.location.href = 'http://localhost/ArenaRental/view/Dono/html/registrar.php';
            </script>
        ";
        exit();
        }
    ...
    function inserirRegistro($pdo, $cpf, $nome, $email, $senha, $tipo = "Dono") {
        ...
        echo "
            <script type=\"text/javascript\">
                alert(\"Registrado com sucesso!.\");
                 window.location.href = 'http://localhost/ArenaRental/view/Dono/html/inserir.foto.php';
            </script>
        ";
        exit();
    } else {
