    ...
    <section id="SecInfo">
        <div>
            <div id="Info">
                ...
                <h2><?php echo "" . htmlspecialchars($owner->getLocalizacao()) ?></br> CEP:
                    <?php echo "" . htmlspecialchars($owner->getCep());?></h2>
            </div>
...
if (!empty($quadras)) {
    foreach ($quadras as $quadra) { ?>
                <div id="quadra-item">
                    <?php echo "<a href='hoje.php?id=" . $quadra['id'] . "' class='quadra-link'>"; ?>
            ...
            // Definir os SVGs para cada recurso
            const svgBebedouro = `
    ...
    ?>
                ...
                ?>
                        <tr>
                            ...
                            <td id="td-css">
                                <form method="POST"
                                    action="../../controllers/OwnerController.php?action=confirmarReserva"
                                    style="display: inline-block;">
                                    <input type="hidden" name="reserva_id"
                                        value="<?php echo $reserva['reserva_id']; ?>">
                                    <button type="submit" class="btn btn-success">Confirmar</button>
                                </form>

                                <form onsubmit="return confirmarCancelamento(event, <?= $reserva['reserva_id']; ?>)">
    ...
    function confirmarCancelamento(event, reservaId) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                form.method = 'POST';
                form.action = '../../controllers/OwnerController.php?action=cancelarReserva';
