...
<body>
    ...
    <section>
        ...
        <div id="Quad">
            <form action="../../controllers/AuthController.php?action=registerUser" method="post"
                ...
                <input type="password" id="confirmarsenha" placeholder="Confirmar senha" name="confirmarsenha"
                    required><br>
            ...
            <script src="../../resources/js/user.senhas.js"></script>
        </div>
    </section>
