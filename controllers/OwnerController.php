...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST") {
        if ($action === 'reservar') {
            ...
            $mensagem = Owner::reservarQuadra($quadra_id, $data, $horario_inicio, $horario_fim, $nome_cliente, $valor);
        ...
        if ($action === 'intervalo') {
            ...
            // Chama a função marcarIntervalo na classe Owner
            $mensagem = Owner::marcarIntervalo($quadra_id, $data, $horario_inicio, $horario_fim);
        ...
        if ($action === 'cancelarReserva') {
            ...
            $redirectUrl = isset($_POST['redirect_url']) ? urldecode($_POST['redirect_url']) : '../views/owner/gerenciador.php';
